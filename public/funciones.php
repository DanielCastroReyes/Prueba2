...
if (session_status() === PHP_SESSION_NONE) {
    session_start(); // Iniciar la sesión de PHP si no está iniciada
}

require 'dirs.php';         // Archivo que contiene las rutas de los directorios (si lo necesitas, sino puedes eliminarlo)
require_once 'conexion.php'; // Archivo que contiene la clase Conexion
require_once 'auth.php';     // Archivo que contiene la clase Auth
require_once 'helpers.php';  // Archivo que contiene funciones auxiliares
require_once 'msg.php';      // Archivo que contiene los mensajes de alerta
